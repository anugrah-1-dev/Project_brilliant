...
@section('title', 'Tambah Program Belajar')
        ...
        <div class="row g-4">
          <div class="col-12">
            <div class="form-group">
              ...
              <div class="form-control-wrap">
                <input type="text" name="name" id="name" value="{{ old('name') }}" placeholder="Masukkan nama program belajar"
          ...
          <div class="col-12">
            <div class="form-group">
              ...
              <div class="form-control-wrap">
                <input type="number" min="0" name="admin_tax" id="admin_tax" value="{{ old('admin_tax') }}"
          ...
          <div class="col-12">
            <div class="form-group">
              ...
              <div class="form-control-wrap">
                <input type="text" name="duration" id="duration" value="{{ old('duration') }}" placeholder="Masukkan durasi (hari) program belajar "
                  class="form-control form-control-lg" />
            ...
            <div class="form-group">
              ...
              <div class="form-control-wrap">
                <select name="type" data-ui="lg" class="form-select js-select2">
                  ...
                  <option value="offline" {{ old('type') == 'offline' ? 'selected' : '' }}>Kelas Offline</option>
                  <option value="online" {{ old('type') == 'online' ? 'selected' : '' }}>Kelas Online</option>
                  <option value="combo" {{ old('type') == 'combo' ? 'selected' : '' }}>Kelas Offline + Liburan</option>
                  <option value="holiday-member" {{ old('type') == 'holiday-member' ? 'selected' : '' }}>Paket Liburan (Khusus Member)</option>
                </select>
