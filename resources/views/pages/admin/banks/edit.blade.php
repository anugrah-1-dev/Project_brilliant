...
@section('title', 'Edit Bank Pembayaran')
    ...
    <div class="nk-block-head-content">
      <div class="nk-block-head-sub">
        <a class="back-to" href="{{ route('admin.banks.index') }}">
          <em class="icon ni ni-arrow-left"></em><span>List Bank</span>
        </a>
      </div>
    </div>
  </div>
        ...
        <div class="row g-4">
          <div class="col-12">
            <div class="form-group">
              ...
              <div class="form-control-wrap">
                <input type="text" name="name" id="name" value="{{ old('name', $bank->name) }}" placeholder="Masukkan nama bank"
          ...
          <div class="col-12">
            <div class="form-group">
              ...
              <div class="form-control-wrap">
                <input type="text" name="number" id="number" value="{{ old('number', $bank->number) }}" placeholder="Masukkan nomor rekening bank"
                  class="form-control form-control-lg" />
          ...
          <div class="col-12">
            <div class="form-group">
              ...
              <div class="form-control-wrap">
                <input type="text" name="owner" id="owner" value="{{ old('owner', $bank->owner) }}" placeholder="Masukkan nama pemilik rekening"
                  class="form-control form-control-lg" />
