...
<head>
  ...
  <title>Asrama VIP | {{ config('app.name') }}</title>
...
<body>
  ...
  <div id="gallery-container">
    <div class="title">Gallery Live Tour Homestay VIP Brilliant English Course</div>
  </div>
  ...
  <script>
    ...
    gallery = ['dalam_vip', 'luar_vip_putra', 'luar_vip_putri'];
    path = "{{ asset('assets/360/asrama/vip/') }}";
    format = '.jpeg';

    urls = [
      "{{ asset('assets/360/asrama/vip/dalam_vip.jpeg') }}",
      "{{ asset('assets/360/asrama/vip/luar_vip_putra.jpeg') }}",
      "{{ asset('assets/360/asrama/vip/luar_vip_putri.jpeg') }}",
    ];
